...
const hemisphereLight = new THREE.HemisphereLight('#D800D8', '#004D40', 0.6)
...
const spotLight = new THREE.SpotLight(0x78ff00, 0.5, 5,
  Math.PI * 0.1, 0.25, 1)
...
pointLightFolder.add(pointLight.position, 'x', 0, 2, 0.0001)
pointLightFolder.add(pointLight.position, 'y', 0, 2, 0.0001)
